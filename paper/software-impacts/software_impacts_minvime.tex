...
Machine learning projects are typically undertaken with an expectation
that they will add some value to a process used by a system or organisation.
This value relies on both the performance characteristics of the model
...
the problem, the machine learning literature focuses on improving the
model performance in a manner disconnected from the application.

The focus of cost-sensitive machine learning literature
